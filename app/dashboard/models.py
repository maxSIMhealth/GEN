...
class DashboardSetting(TimeStampedModel):
    ...
    image = models.ImageField(
        ...
        null=True,
        help_text=_(
            "'Hero' image that will be displayed on top portion of the dashboard (home page)."
        ),
    )
    ...
    active = models.BooleanField(
        _("active"),
        help_text=_(
            "Set this setting as the active one. **WARNING**: only one setting can be set as active."
        ),
    )
