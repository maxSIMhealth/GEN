...
class QuizDetails:
    def __init__(self, enabled, current_attempt_number, attempts_left, latest_quizscore):
...
def quiz_details_get(user, quiz):
    enabled, current_attempt_number, attempts_left, latest_quizscore = quiz_enable_check(user, quiz)
