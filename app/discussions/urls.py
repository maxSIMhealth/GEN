...
urlpatterns = [
    ...
    path(
        "courses/<int:pk>/section/<int:section_pk>/discussion/<int:sectionitem_pk>/upvote/",
        discussion_views.upvote_discussion,
        name="discussion_upvote",
    ),
    path(
        "courses/<int:pk>/section/<int:section_pk>/discussion/<int:sectionitem_pk>/clearvote/",
        discussion_views.clearvote_discussion,
        name="discussion_clearvote",
    ),
    path(
        "courses/<int:pk>/section/<int:section_pk>/discussion/<int:sectionitem_pk>/comment/<int:comment_pk>/upvote/",
        discussion_views.upvote_comment,
        name="comment_upvote",
    ),
    path(
        "courses/<int:pk>/section/<int:section_pk>/discussion/<int:sectionitem_pk>/comment/<int:comment_pk>/clearvote/",
