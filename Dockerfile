...
CMD gunicorn GEN.asgi:application --bind :8000 --workers 2 --worker-class uvicorn.workers.UvicornWorker --worker-tmp-dir /dev/shm --timeout $GUNICORN_TIMEOUT --log-level $GUNICORN_LOGLEVEL
